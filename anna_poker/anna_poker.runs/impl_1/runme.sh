...
HD_PWD='C:/Poker/anna_poker/anna_poker.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_screen.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_screen.tcl -notrace
