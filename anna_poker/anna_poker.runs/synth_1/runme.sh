...
HD_PWD='C:/Poker/anna_poker/anna_poker.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_screen.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_screen.tcl
