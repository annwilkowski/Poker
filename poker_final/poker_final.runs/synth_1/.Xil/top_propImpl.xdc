set_property SRC_FILE_INFO {cfile:C:/Users/sidra/Documents/GitHub/Poker/poker_final/poker_final.srcs/constrs_1/imports/pin_assignment/mb_usb_hdmi_top.xdc rfile:../../../poker_final.srcs/constrs_1/imports/pin_assignment/mb_usb_hdmi_top.xdc id:1} [current_design]
...
connect_debug_port u_ila_0/probe0 [get_nets [list {poker_game/round_fsm/deal_count_reg[0]} {poker_game/round_fsm/deal_count_reg[1]} {poker_game/round_fsm/deal_count_reg[2]} {poker_game/round_fsm/deal_count_reg[3]}]]
...
connect_debug_port u_ila_0/probe1 [get_nets [list {flop_cards[2][suit][0]} {flop_cards[2][suit][1]}]]
...
connect_debug_port u_ila_0/probe2 [get_nets [list {flop_cards[0][suit][0]} {flop_cards[0][suit][1]}]]
...
connect_debug_port u_ila_0/probe3 [get_nets [list {flop_cards[1][rank][0]} {flop_cards[1][rank][1]} {flop_cards[1][rank][2]} {flop_cards[1][rank][3]}]]
...
connect_debug_port u_ila_0/probe4 [get_nets [list {flop_cards[0][rank][0]} {flop_cards[0][rank][1]} {flop_cards[0][rank][2]} {flop_cards[0][rank][3]}]]
...
connect_debug_port u_ila_0/probe5 [get_nets [list {flop_cards[2][rank][0]} {flop_cards[2][rank][1]} {flop_cards[2][rank][2]} {flop_cards[2][rank][3]}]]
...
connect_debug_port u_ila_0/probe6 [get_nets [list {flop_cards[1][suit][0]} {flop_cards[1][suit][1]}]]
...
connect_debug_port u_ila_0/probe7 [get_nets [list {poker_game/round_fsm/top_card[rank][0]} {poker_game/round_fsm/top_card[rank][1]} {poker_game/round_fsm/top_card[rank][2]} {poker_game/round_fsm/top_card[rank][3]}]]
...
connect_debug_port u_ila_0/probe8 [get_nets [list {poker_game/round_fsm/top_card[suit][0]} {poker_game/round_fsm/top_card[suit][1]}]]
...
connect_debug_port u_ila_0/probe9 [get_nets [list poker_game/round_fsm/draw_card_reg_0]]
