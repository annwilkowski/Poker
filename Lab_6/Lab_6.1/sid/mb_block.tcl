...
proc create_root_design { parentCell } {
  ...
  set usp_spi_ss [ create_bd_port -dir O -from 0 -to 0 usp_spi_ss ]
  ...
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M05_AXI [get_bd_intf_pins gpio_usb_rst/S_AXI] [get_bd_intf_pins microblaze_0_axi_periph/M05_AXI]
  ...
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M07_AXI [get_bd_intf_pins microblaze_0_axi_periph/M07_AXI] [get_bd_intf_pins timer_usb_axi/S_AXI]
  ...
  connect_bd_net -net gpio_usb_int_ip2intc_irpt [get_bd_pins gpio_usb_int/ip2intc_irpt] [get_bd_pins xlconcat_0/In3]
  ...
  connect_bd_net -net microblaze_0_Clk [get_bd_pins axi_gpio_1/s_axi_aclk] [get_bd_pins axi_uartlite_0/s_axi_aclk] [get_bd_pins clk_wiz_1/clk_out1] [get_bd_pins gpio_usb_int/s_axi_aclk] [get_bd_pins gpio_usb_keycode/s_axi_aclk] [get_bd_pins gpio_usb_rst/s_axi_aclk] [get_bd_pins microblaze_0/Clk] [get_bd_pins microblaze_0_axi_intc/processor_clk] [get_bd_pins microblaze_0_axi_intc/s_axi_aclk] [get_bd_pins microblaze_0_axi_periph/ACLK] [get_bd_pins microblaze_0_axi_periph/M00_ACLK] [get_bd_pins microblaze_0_axi_periph/M01_ACLK] [get_bd_pins microblaze_0_axi_periph/M02_ACLK] [get_bd_pins microblaze_0_axi_periph/M03_ACLK] [get_bd_pins microblaze_0_axi_periph/M04_ACLK] [get_bd_pins microblaze_0_axi_periph/M05_ACLK] [get_bd_pins microblaze_0_axi_periph/M06_ACLK] [get_bd_pins microblaze_0_axi_periph/M07_ACLK] [get_bd_pins microblaze_0_axi_periph/S00_ACLK] [get_bd_pins microblaze_0_local_memory/LMB_Clk] [get_bd_pins rst_clk_wiz_1_100M/slowest_sync_clk] [get_bd_pins spi_usb/ext_spi_clk] [get_bd_pins spi_usb/s_axi_aclk] [get_bd_pins timer_usb_axi/s_axi_aclk]
  ...
  connect_bd_net -net rst_clk_wiz_1_100M_peripheral_aresetn [get_bd_pins axi_gpio_1/s_axi_aresetn] [get_bd_pins axi_uartlite_0/s_axi_aresetn] [get_bd_pins gpio_usb_int/s_axi_aresetn] [get_bd_pins gpio_usb_keycode/s_axi_aresetn] [get_bd_pins gpio_usb_rst/s_axi_aresetn] [get_bd_pins microblaze_0_axi_intc/s_axi_aresetn] [get_bd_pins microblaze_0_axi_periph/ARESETN] [get_bd_pins microblaze_0_axi_periph/M00_ARESETN] [get_bd_pins microblaze_0_axi_periph/M01_ARESETN] [get_bd_pins microblaze_0_axi_periph/M02_ARESETN] [get_bd_pins microblaze_0_axi_periph/M03_ARESETN] [get_bd_pins microblaze_0_axi_periph/M04_ARESETN] [get_bd_pins microblaze_0_axi_periph/M05_ARESETN] [get_bd_pins microblaze_0_axi_periph/M06_ARESETN] [get_bd_pins microblaze_0_axi_periph/M07_ARESETN] [get_bd_pins microblaze_0_axi_periph/S00_ARESETN] [get_bd_pins rst_clk_wiz_1_100M/peripheral_aresetn] [get_bd_pins spi_usb/s_axi_aresetn] [get_bd_pins timer_usb_axi/s_axi_aresetn]
  ...
  connect_bd_net -net spi_usb_ss_o [get_bd_ports usp_spi_ss] [get_bd_pins spi_usb/ss_o]
  connect_bd_net -net timer_usb_axi_interrupt [get_bd_pins timer_usb_axi/interrupt] [get_bd_pins xlconcat_0/In1]
  ...
  assign_bd_address -offset 0x40030000 -range 0x00010000 -target_address_space [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs gpio_usb_rst/S_AXI/Reg] -force
