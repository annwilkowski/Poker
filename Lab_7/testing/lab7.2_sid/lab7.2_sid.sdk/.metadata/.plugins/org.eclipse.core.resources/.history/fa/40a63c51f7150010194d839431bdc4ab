...
/***************************** Include Files *******************************/
#include "src/hdmi_text_controller.h"
...
void setColorPalette (uint8_t color, uint8_t red, uint8_t green, uint8_t blue)
{
	...
	// color is 0-15 which is 4 bits
	// red, green, blue is 4 bits
	hdmi_ctrl->Palette[color*2] = ((green & 0xF0) << 4) | (blue & 0x0F); // Blue and Green
	hdmi_ctrl->Palette[color*2] = red & 0x0F; // Red and Empty
}
