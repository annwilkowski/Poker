...
module hdmi_text_controller_v1_0 #(
    ...
    // VRAM
    logic [10:0] vram_word_select;
    logic [C_AXI_DATA_WIDTH-1:0] vram_data_out;
    logic [31:0] fgd_palette;
    logic [31:0] bkg_palette;
    logic [2:0] fgd_palette_sel;
    logic [2:0] bkg_palette_sel;
    ...
    hdmi_text_controller_v1_0_AXI #(
        ...
        //User ports
        .vram_word_select(vram_word_select),
        .vram_data_out(vram_data_out),
        .bkg_palette_sel(bkg_palette_sel),
        .fgd_palette_sel(fgd_palette_sel),
        .fgd_palette(fgd_palette),
