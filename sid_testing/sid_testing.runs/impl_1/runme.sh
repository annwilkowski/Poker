...
HD_PWD='C:/Users/sidra/Documents/GitHub/Poker/sid_testing/sid_testing.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log hand_comparator.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source hand_comparator.tcl -notrace
